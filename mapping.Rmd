...
# This is a practice comment lol
...
* Tell your groupmates to pull in Slack
```{r}
# I am planning on removing NA values, but am having trouble with the code, I am going to take a break and revisit
...
First read the csv
```{r}
horsetailFromCSV = read_csv("horsetail.csv")
horsetailFromCSV
```
